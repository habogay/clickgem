...
const char * const BITCOIN_CONF_FILENAME = "clickgem.conf";
const char * const BITCOIN_PID_FILENAME = "clickgemd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Clickgem";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Clickgem";
#else
    // Unix
    return pathRet / ".clickgem";
#endif
#endif
}
